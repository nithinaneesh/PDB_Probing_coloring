...
def corona():
    ...
    cmd.set_color("col1", '[1.0,0.949,0.8]' )
    cmd.set_color("col2", '[1.0,0.6,0.0]' )
    cmd.set_color("col3", '[1.0,0.0,0.0]' )
    cmd.set_color("col4", '[0.8,0.0,0.0]' )
    cmd.set_color("col5", '[0.6,0.0,0.0]')
    ...
    #cmd.spectrum('b', '#fff2cc_#ff9900_#ff0000_#980000', minimum=0, maximum=100, byres=1)
    cmd.spectrum('b', 'col1_col2_col3_col4_col5', minimum=0, maximum=100, byres=1)
